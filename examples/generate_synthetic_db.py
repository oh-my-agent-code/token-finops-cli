"""Generate a synthetic Copilot session-store.db for demos and tests.

Builds a throwaway SQLite database with only the columns this tool's
...
def build_synthetic_db(path, days=14, events_per_day=8, seed=42):
    ...
    for day_offset in range(days):
        ...
        for _ in range(events_per_day):
            ...
            total_nano_aiu = int((input_tokens + output_tokens) * rng.uniform(150_000_000, 400_000_000))
            rows.append((
